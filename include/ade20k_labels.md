## 🏷️ Class Labels for ADE20K Panoptic Dataset (used by pFCN)

These are the standard class labels used in the `ADE20K` Panoptic dataset. You can use them to configure label-to-name mappings in your ROS parameters or YAML config files.
