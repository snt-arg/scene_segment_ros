...
from utils.helpers import getRootAbsolutePath, getYosoFilteredSegments, getFCNFilteredSegments
...
def pFCNSegmenter(image, model, classes):
    ...
    # Filter the segments
    filteredPreds, predictionProbs = getFCNFilteredSegments(
        predictions, classes)
    # Return
...
def yosoSegmenter(image, model, classes):
    ...
    predictions = model(image)
    # Filter the segments
    filteredPreds, seg_dict, predictionProbs = getYosoFilteredSegments(
        predictions, classes)
    # Return
    return filteredPreds, seg_dict, predictionProbs
